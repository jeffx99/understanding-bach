...
\begin{center}
  \begin{lilypond}[staffsize=16]
    ...
    <<
    \relative { \clef bass \override Stem #'transparent = ##t s4 d b s8 }
    \figures {
      s4 <6 3>4 <6 5 3>4
    }
    >>
...
2 & 5 & 9         & \degree{7} -- \degree{1}  & cadence on m. 8; no elision \\ \hline
3 & 9 & 13        &	\degree{7} -- \degree{1}	&	cadence on m. 12; no elision; \textbf{e}$\flat$ introduced to tonicize \textbf{B}$\flat$  \\ \hline
4 & 13 & 17       &	\degree{4} -- \degree{3}	& cadence on m. 16; no elision	\\ \hline
5 & 17 & 21\up{+} &	\degree{7} -- \degree{1}	&	\\ \hline
